...
const RegisterPWD = ({ show, handleClose }) => {
  return (
    <Modal
      show={show}
      onHide={handleClose}
    ...
    >
      ...
      <Modal.Body>
        <Form>
          ...
          <Row className="mb-3">
            <Col md={6}>
              <FloatingLabel controlId="floatingSex" label="Sex">
          ...
          <Row className="mb-3">
            <Col md={6}>
              <FloatingLabel controlId="floatingDisabilityType" label="Type of Disability (Please check only one)">
                <Form.Select aria-label="Type of Disability">
                  ...
                  <option value="orthopedic">Orthopedic Disability (Musculoskeletal)</option>
                </Form.Select>
              </FloatingLabel>
            </Col>
            <Col md={6}>
              <FloatingLabel controlId="floatingCivilStatus" label="Civil Status">
          ...
          <Row className="mb-3">
            ...
            <Col md={4}>
              <FloatingLabel controlId="floatingSelectDisabilityCause" label="Cause of Disability">
            ...
            <Col md={4}>
              <FloatingLabel controlId="floatingEducationalAttainment" label="Educational Attainment">
          ...
          <Row className="mb-3">
            <Col md={12}>
              <FloatingLabel controlId="floatingSelectEmployment" label="Employment Status">
